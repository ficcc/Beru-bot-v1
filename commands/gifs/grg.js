...
// module.exports = class GrgCommand extends Command {
//   constructor(client) {
//     super(client, {
//       name: '',
//       aliases: ['grg-gif', 'grg-bro'],
//       group: 'gifs',
//       memberName: 'grg',
//       description: 'Replies with a grg gif!',
//       throttling: {
//       usages: 2,
//       duration: 8
//       }
...
//     try {
//       const linkArray = fs
//         .readFileSync('././resources/gifs/grglinks.txt', 'utf8')
//         .split('\n');
...
//       */
//     } catch (e) {
//       message.reply(':x: Failed to fetch a grg gif!');
//       return console.error(e);
//     }
//   }
// };
